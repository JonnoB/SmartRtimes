SaveManyRDS <- function(FileName, FolderPath, Chunksize=1e5, CallFunction = NULL, skip = 0){
  ...
  read_csv_chunked(FileName, SideEffectChunkCallback$new(g), chunk_size = Chunksize, skip)
